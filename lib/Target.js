...
const { ansiLabel, registerLabel } = require('./print');
...
function Target({
    ...
    /**
     * Cleanup is not strictly necessary... but it helps make sure we always key
     * off the envelope and don't accidentally couple to implementation.
     */
...
const isTargetName = Target.isTargetName = exports.isTargetName = (prev, v) =>
    !/^--?/.test(prev || '') && !/^--?/.test(v);
