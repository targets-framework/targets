...
const DashboardUpdate = () => modes[SystemStore.get('mode')].updateDashboard;
const QueueReportUpdate = () => modes[SystemStore.get('mode')].updateQueueReport;
